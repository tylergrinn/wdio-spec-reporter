...
class SpecReporter extends events.EventEmitter {
    ...
    getSuiteResult (runner) {
        ...
        const showPreface = this.options.showPreface !== false // default to true, pass { showPreface: false } to disable
        const preface = showPreface ? `[${this.getBrowserCombo(results.capabilities, false)} #${cid}]` : ''
